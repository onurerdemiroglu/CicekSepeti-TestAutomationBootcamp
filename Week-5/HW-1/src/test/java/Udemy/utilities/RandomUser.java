...
public class RandomUser {
    ...
    public String getRandomCategory() throws FileNotFoundException {
        Scanner category = new Scanner(new File(System.getProperty("user.dir") + "/bin/categories.txt"));
        StringBuilder n = new StringBuilder();

        while (category.hasNext()) {
            n.append(category.nextLine());
        }
        String[] categoryArray = n.toString().split(",");
